 ...
 * @author Zhunio
 */
public class Nurse extends HealthEmployer{
    
    private int code_nur;
    ...
    public Nurse(String levelCompetition, double qualification_hea, String tuitionNumber_hea, double salary_hea, Department department_hea, String id_per, String firstName_per, String secondName_per, String lastName_per, String mothersLastName_per, String phone_per, String reservationPhone_per, Gender gender_per, String email_per, Date birthDate_per, CivilStatus civilStatus_per) {
        ...
        this.levelCompetition = levelCompetition;
    }

    public int getCode_nur() {
        return code_nur;
    }

    public String getLevelCompetition() {
        return levelCompetition;
    }

    public void setLevelCompetition(String levelCompetition) {
        this.levelCompetition = levelCompetition;
    }
